...
# outputList_dvs$tab_effects %>% filter(!grepl("BMI", Model)) %>% kable() %>%
#   kable_styling() %>% group_rows("Intervention by age", 3, 6)
...
# 2) joint plot of all interactions
...
EEF
"
gg_sex1 + gg_sex2 + gg_age1 + gg_age2 + gg_bmi1 + gg_bmi2 +
  patchwork::plot_layout(design = layout)
# ggsave("FigureS3_alphaDiversity_stratifications.png", width = 14, height = 10)
```
