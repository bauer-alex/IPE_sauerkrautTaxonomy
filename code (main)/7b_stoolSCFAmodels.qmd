...
Only perform it regarding Butyric acid as one central SCFA.
...
dat_test <- dat_model %>% 
  ...
  summarize(group                  = first(group),
            interventionEffect_raw = stool_butyricAcid[2] - stool_butyricAcid[1]) %>% 
  ungroup() %>% 
  group_by(participant_id) %>% 
  summarize(group = first(group),
...
m_methylbutyric_acid2_fibInt            <- outputList_methylbutyric_acid2$model_gaussianLog_fibInt
m_methylbutyric_acid2_fibInt_changedRef <- outputList_methylbutyric_acid2$model_gaussianLog_fibInt_changedRef
m_methylbutyric_acid2_divInt            <- outputList_methylbutyric_acid2$model_gaussianLog_divInt
m_methylbutyric_acid2_divInt_changedRef <- outputList_methylbutyric_acid2$model_gaussianLog_divInt_changedRef
```
...
m_acetic_acid_fibInt            <- outputList_acetic_acid$model_gamma_fibInt
m_acetic_acid_fibInt_changedRef <- outputList_acetic_acid$model_gamma_fibInt_changedRef
m_acetic_acid_divInt            <- outputList_acetic_acid$model_gamma_divInt
m_acetic_acid_divInt_changedRef <- outputList_acetic_acid$model_gamma_divInt_changedRef
```
...
m_butyric_acid_fibInt            <- outputList_butyric_acid$model_gamma_fibInt
m_butyric_acid_fibInt_changedRef <- outputList_butyric_acid$model_gamma_fibInt_changedRef
m_butyric_acid_divInt            <- outputList_butyric_acid$model_gamma_divInt
m_butyric_acid_divInt_changedRef <- outputList_butyric_acid$model_gamma_divInt_changedRef
```
...
m_hexanoic_acid_fibInt            <- outputList_hexanoic_acid$model_gaussian_fibInt
m_hexanoic_acid_fibInt_changedRef <- outputList_hexanoic_acid$model_gaussian_fibInt_changedRef
m_hexanoic_acid_divInt            <- outputList_hexanoic_acid$model_gaussian_divInt
m_hexanoic_acid_divInt_changedRef <- outputList_hexanoic_acid$model_gaussian_divInt_changedRef
```
...
m_isobutyric_acid_fibInt            <- outputList_isobutyric_acid$model_gamma_fibInt
m_isobutyric_acid_fibInt_changedRef <- outputList_isobutyric_acid$model_gamma_fibInt_changedRef
m_isobutyric_acid_divInt            <- outputList_isobutyric_acid$model_gamma_divInt
m_isobutyric_acid_divInt_changedRef <- outputList_isobutyric_acid$model_gamma_divInt_changedRef
```
...
m_isovaleric_acid_fibInt            <- outputList_isovaleric_acid$model_gamma_fibInt
m_isovaleric_acid_fibInt_changedRef <- outputList_isovaleric_acid$model_gamma_fibInt_changedRef
m_isovaleric_acid_divInt            <- outputList_isovaleric_acid$model_gamma_divInt
m_isovaleric_acid_divInt_changedRef <- outputList_isovaleric_acid$model_gamma_divInt_changedRef
```
...
m_propionic_acid_fibInt            <- outputList_propionic_acid$model_gamma_fibInt
m_propionic_acid_fibInt_changedRef <- outputList_propionic_acid$model_gamma_fibInt_changedRef
m_propionic_acid_divInt            <- outputList_propionic_acid$model_gamma_divInt
m_propionic_acid_divInt_changedRef <- outputList_propionic_acid$model_gamma_divInt_changedRef
```
...
m_valeric_acid_fibInt            <- outputList_valeric_acid$model_gaussian_fibInt
m_valeric_acid_fibInt_changedRef <- outputList_valeric_acid$model_gaussian_fibInt_changedRef
m_valeric_acid_divInt            <- outputList_valeric_acid$model_gaussian_divInt
m_valeric_acid_divInt_changedRef <- outputList_valeric_acid$model_gaussian_divInt_changedRef
```
...
model_fibInt_list <- list("Acetic acid (Stool)"          = list(m_acetic_acid_fibInt, m_acetic_acid_fibInt_changedRef),
                          "Propionic acid (Stool)"       = list(m_propionic_acid_fibInt, m_propionic_acid_fibInt_changedRef),
                          "Butyric acid (Stool)"         = list(m_butyric_acid_fibInt, m_butyric_acid_fibInt_changedRef),
                          "Valeric acid (Stool)"         = list(m_valeric_acid_fibInt, m_valeric_acid_fibInt_changedRef),
                          "Hexanoic acid (Stool)"        = list(m_hexanoic_acid_fibInt, m_hexanoic_acid_fibInt_changedRef),
                          "Iso-butyric acid (Stool)"     = list(m_isobutyric_acid_fibInt, m_isobutyric_acid_fibInt_changedRef),
                          "Iso-valeric acid (Stool)"     = list(m_isovaleric_acid_fibInt, m_isovaleric_acid_fibInt_changedRef),
                          "2-Methylbutyric acid (Stool)" = list(m_methylbutyric_acid2_fibInt, m_methylbutyric_acid2_fibInt_changedRef))
model_divInt_list <- list("Acetic acid (Stool)"          = list(m_acetic_acid_divInt, m_acetic_acid_divInt_changedRef),
                          "Propionic acid (Stool)"       = list(m_propionic_acid_divInt, m_propionic_acid_divInt_changedRef),
                          "Butyric acid (Stool)"         = list(m_butyric_acid_divInt, m_butyric_acid_divInt_changedRef),
                          "Valeric acid (Stool)"         = list(m_valeric_acid_divInt, m_valeric_acid_divInt_changedRef),
                          "Hexanoic acid (Stool)"        = list(m_hexanoic_acid_divInt, m_hexanoic_acid_divInt_changedRef),
                          "Iso-butyric acid (Stool)"     = list(m_isobutyric_acid_divInt, m_isobutyric_acid_divInt_changedRef),
                          "Iso-valeric acid (Stool)"     = list(m_isovaleric_acid_divInt, m_isovaleric_acid_divInt_changedRef),
                          "2-Methylbutyric acid (Stool)" = list(m_methylbutyric_acid2_divInt, m_methylbutyric_acid2_divInt_changedRef))
  ...
  results_dat <- summary(model)$p.table %>% 
    ...
    mutate(parameter   = row.names(.),
           param_group = case_when(parameter %in% c("interventionFresh", "interventionPasteurized") ~ "intervention",
                                   ...
                                   grepl("dailyFiber",  parameter)                                  ~ "daily fiber",
                                   grepl("baselineDiv", parameter)                                  ~ "baseline diversity",
                                   TRUE                                                             ~ parameter)) %>% 
...
ylim_gaussianInt <- c(-1, 1)
gg_gaussian_divInt <- plot_dat %>% 
  filter(grepl("acid", model)) %>% 
  ...
  facet_wrap(~ parameter) +
  ggtitle("diversity-specific Intervention effects in Gaussian models", "with uncorrected 95% confidence intervals") +
  theme(axis.text.x        = element_text(hjust = 1, angle = 45),
        axis.title.x       = element_blank(),
        panel.grid.minor.y = element_line(color = "gray96"),
        panel.grid.major.x = element_blank(),
...
gg_exp_divInt <- plot_dat %>% 
  ...
  scale_shape_manual("Baseline diversity group", values = c(25,24)) +
  facet_wrap(~ parameter) +
  ggtitle("diversity-specific Intervention effects in log Gaussian and Gamma models", "with uncorrected 95% confidence intervals") +
  theme(axis.text.x        = element_text(hjust = 1, angle = 45),
        axis.title.x       = element_blank(),
        panel.grid.minor.y = element_line(color = "gray96"),
        panel.grid.major.x = element_blank(),
...
## Interactions: Intervention by daily fiber consumption
...
gg_gaussian_fibInt <- plot_dat %>% 
  ...
  facet_wrap(~ parameter) +
  ggtitle("Fiber-specific Intervention effects in Gaussian models", "with uncorrected 95% confidence intervals") +
  theme(axis.text.x        = element_text(hjust = 1, angle = 45),
        axis.title.x       = element_blank(),
        panel.grid.minor.y = element_line(color = "gray96"),
        panel.grid.major.x = element_blank(),
...
gg_exp_fibInt <- plot_dat %>% 
  ...
  scale_shape_manual("Fiber group", values = c(25,24)) +
  facet_wrap(~ parameter) +
  ggtitle("Fiber-specific Intervention effects in log Gaussian and Gamma models", "with uncorrected 95% confidence intervals") +
  theme(axis.text.x        = element_text(hjust = 1, angle = 45),
        axis.title.x       = element_blank(),
        panel.grid.minor.y = element_line(color = "gray96"),
        panel.grid.major.x = element_blank(),
...
results_dat_divInt %>% 
  select(model, model_type, div_group, parameter, pvalue, pvalue_significant) %>% 
  kable() %>% 
  kable_styling()
...
results_dat_fibInt %>% 
  select(model, model_type, fib_group, parameter, pvalue, pvalue_significant) %>% 
  kable() %>% 
  kable_styling()
```
...
# write.csv(results_dat, file = "7b_resultsDat_stoolSCFAmodels.csv", row.names = FALSE)
# write.csv(results_dat_divInt, file = "7b_resultsDat_divInt_stoolSCFAmodels.csv", row.names = FALSE)
# write.csv(results_dat_ageInt, file = "7b_resultsDat_ageInt_stoolSCFAmodels.csv", row.names = FALSE)
# write.csv(results_dat_sexInt, file = "7b_resultsDat_sexInt_stoolSCFAmodels.csv", row.names = FALSE)
# write.csv(results_dat_bmiInt, file = "7b_resultsDat_bmiInt_stoolSCFAmodels.csv", row.names = FALSE)
# write.csv(results_dat_fibInt, file = "7b_resultsDat_fibInt_stoolSCFAmodels.csv", row.names = FALSE)
...
# ggsave("FigureS14_stoolSCFAs_stratifications.png", width = 16, height = 16)
```
