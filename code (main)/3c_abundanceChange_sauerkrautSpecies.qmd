---
title: "Description Microbiome Changes with focus on Sauerkraut species"
format:
  html:
    toc: true
    code-fold: true
...
In the following there's one plot and table for each bacteria species
appearing in the Sauerkraut samples.  
...
species_vec <- c("Bifidobacterium_adolescentis",      "Bifidobacterium_longum",
                 "Collinsella_aerofaciens",           "Prevotella_copri_clade_A",
                 "Enterococcus_casseliflavus",        "Enterococcus_faecium",
                 "Lacticaseibacillus_paracasei",      "Latilactobacillus_sakei",
                 "Levilactobacillus_brevis",          "Limosilactobacillus_reuteri",
                 "Leuconostoc_citreum",               "Leuconostoc_fallax",
                 "Leuconostoc_mesenteroides",         "Weissella_cibaria",
                 "Lactococcus_lactis",                "GGB9758_SGB15368",
                 "Anaerostipes_hadrus",               "Blautia_faecis",
                 "Blautia_wexlerae",                  "Fusicatenibacter_saccharivorans",
                 "Roseburia_faecis",                  "Roseburia_intestinalis",
                 "Candidatus_Cibiobacter_qucibialis", "Ruminococcus_bromii",
                 "Bradyrhizobium_elkanii",            "Bradyrhizobium_sp_17_4",
